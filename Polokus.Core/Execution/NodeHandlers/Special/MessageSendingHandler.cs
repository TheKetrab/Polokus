...
{
    public class MessageSendingHandler<T> : NodeHandler<T> where T : tFlowNode
    {
        public MessageSendingHandler(IProcessInstance processInstance, FlowNode<T> typedNode) : base(processInstance, typedNode)
        {
        }
